...
## data on /mnt/resource/data2 directory
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=120
#SBATCH --exclusive
#SBATCH -J CMAQ
#SBATCH -o /shared/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.10x12pe.2day_remove_native_sleep.cyclecloud.mnt.resource.data2.log
#SBATCH -e /shared/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.10x12pe.2day_remove_native_sleep.cyclecloud.mnt.resource.data2.log
...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = 2016_CONUS_10x12pe_mnt_resource_data2        #> Application Name (e.g. Gridname)
...
#> Set Working, Input, and Output Directories
 ...
 setenv CMAQ_DATA /mnt/resource/data2
 #mkdir $CMAQ_DATA
 setenv OUTDIR  ${CMAQ_DATA}/output_CCTM_${RUNID} #> Output Directory
 setenv INPDIR  /$DISK/resource/data2/CONUS/12US2  #Input Directory
