...
#SBATCH --exclusive
#SBATCH -J CMAQ
#SBATCH -o /shared/build/openmpi_gcc/CMAQ_v54+/CCTM/scripts/run_cctm5.4+_Bench_2018_12US1_M3DRY_cb6r3_ae6_20200131_MYR.256.16x16pe.2day.cyclecloud.lustre.codefix.lu.log
#SBATCH -e /shared/build/openmpi_gcc/CMAQ_v54+/CCTM/scripts/run_cctm5.4+_Bench_2018_12US1_M3DRY_cb6r3_ae6_20200131_MYR.256.16x16pe.2day.cyclecloud.lustre.codefix.lu.log
...
echo 'hardware configuration of the node'
slurmd -C
...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = M3DRY_2018_12US1_M3DRY_cb6r3_ae6_20200131_MYR_256_lustre_codefix_lu  #> Application Name (e.g. Gridname)
...
#  setenv CMAQ_MASKS $SZpath/12US1_surf.ncf
  ...
  setenv N_EMIS_GR 2
  set EMISfile  = emis_mole_all_${YYYYMMDD}_12US1_nobeis_norwc_WR413_MYR_2018.nc4
...
# =====================================================================
  ...
  if ( $CLOBBER_DATA == true || $CLOBBER_DATA == TRUE ) then
     ...
     foreach file ( ${out_test} )
        ...
        rm -f ${OUTDIR}/CCTM_EMDIAG*${RUNID}_${YYYYMMDD}.nc
