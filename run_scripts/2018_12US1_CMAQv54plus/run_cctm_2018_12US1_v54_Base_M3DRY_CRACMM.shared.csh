...
#SBATCH --exclusive
#SBATCH -J CMAQ
#SBATCH -o /shared/build/openmpi_gcc/CMAQ_v54+/CCTM/scripts/run_cctm5.4+_Bench_2018_12US1_CRACMM.192.16x12pe.2day.cyclecloud.shared.log
#SBATCH -e /shared/build/openmpi_gcc/CMAQ_v54+/CCTM/scripts/run_cctm5.4+_Bench_2018_12US1_CRACMM.192.16x12pe.2day.cyclecloud.shared.log
...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = M3DRY_2018_12US1_shared  #> Application Name (e.g. Gridname)
...
#> is located by default).
 set BLD       = ${CMAQ_HOME}/CCTM/scripts/BLD_CCTM_${VRSN}_${compilerString}_M3DRY_CRACMM
...
#> Set Working, Input, and Output Directories
 setenv WORKDIR /shared/build/openmpi_gcc/CMAQ_v54+/CCTM/scripts  #> Working Directory. Where the runscript is.
 setenv DISK shared
 setenv OUTDIR  /$DISK/data/output/output_${RUNID} #> Output Directory
 setenv OUTDIR_2017 /$DISK/data/output/output_${RUNID_2017}
...
#> Set Start and End Days for looping
 ...
 # set START_DATE = "2017-12-22"     #> beginning date (January 1, 2017)
 #set END_DATE   = "2017-12-22"     #> ending date    (December 31, 2017)
...
set BCpath    = $INPDIR/icbc/CMAQv54_2018_108NHEMI_CRACCM1_FROM_CB6R5M_M3DRY
...
# =====================================================================
  ...
  if ($NEW_START == true || $NEW_START == TRUE ) then
     setenv ICFILE CCTM_CGRID_v532_cb6r3_ae7_aq_mapped_to_cracmm1_aq_WR413_MYR_STAGE_2017_12US1_20180701.nc
...
#  set BCFILE = BCON_CONC_12US1_CMAQv533_2018_108NHEMI_STAGE_regrid_${YYYYMM}.nc
 set BCFILE = BCON_CONC_12US1_CMAQv54_2018_108NHEMI_CRACCM1_FROM_CB6R5M_M3DRY_regrid_${YYYYMM}.nc
...
#  setenv CMAQ_MASKS $SZpath/12US1_surf.ncf
  ...
  if ($YYYY == 2017) then
     set EMDATES = $INPDIR/emis/emis_dates/smk_merge_dates_${YYYYMM}_for2018spinup.txt
  else
...
#     setenv PX_VERSION Y     #> MCIP is PX version? [ default: N ]
  ...
  if ( $CTM_ABFLUX == 'Y' ) then
     ...
     setenv E2C_CHEM ${INPDIR}/epic/2018r1_EPIC0509_12US1_time20180710.nc4
...
# =====================================================================
  ...
  #setenv nr_matrix_nml ${NMLpath}/Species_Table_TR_0.nml
