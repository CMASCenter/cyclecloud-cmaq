...
#SBATCH --exclusive
#SBATCH -J CMAQ
#SBATCH -o /shared/build/openmpi_gcc/CMAQ_v54+/CCTM/scripts/run_cctm5.4+_Bench_2018_12US1.192.16x12pe.2day.cyclecloud.lustre.codefix.log
#SBATCH -e /shared/build/openmpi_gcc/CMAQ_v54+/CCTM/scripts/run_cctm5.4+_Bench_2018_12US1.192.16x12pe.2day.cyclecloud.lustre.codefix.log
...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = M3DRY_2018_12US1_192_lustre_codefix  #> Application Name (e.g. Gridname)
...
# setenv BEIS_NORM_EMIS      $IN_BEISpath/beis4_beld6_norm_emis.12US1.ncf     
     setenv BEIS_NORM_EMIS      $IN_BEISpath/beld3_12US1_459X299_output_a.ncf 
...
#  setenv OCEAN_1 /work/MOD3DATA/CMAQv53_TS/misc/12US1_surf.ncf
  ...
  if ( $CTM_ABFLUX == 'Y' ) then
     ...
     setenv E2C_LU $INPDIR/misc/beis4_beld6_norm_emis.12US1.ncf
  endif
...
# =====================================================================
  ...
  #setenv tr_matrix_nml ${NMLpath}/Species_Table_TR_EQUATES_12US1.nml
