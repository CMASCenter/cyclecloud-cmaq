...
#SBATCH --exclusive
#SBATCH -J CMAQ
#SBATCH -o /shared/build/openmpi_gcc/CMAQ_v54+/CCTM/scripts/run_cctm5.4+_Bench_2018_12US1.192.16x12pe.2day.cyclecloud.lustre.codefix.lu.log
#SBATCH -e /shared/build/openmpi_gcc/CMAQ_v54+/CCTM/scripts/run_cctm5.4+_Bench_2018_12US1.192.16x12pe.2day.cyclecloud.lustre.codefix.lu.log
# test of 3 pull requests https://github.com/USEPA/CMAQ/pulls for CMAQv5.4+


# ===================== CCTMv5.3.X Run Script ========================= 
# Usage: run.cctm >&! cctm_2017_12US1.log &                                
#
...
####SBATCH -t 168:00:00
####SBATCH -n 256
####SBATCH -J 2018_v54_12US1_M3DRY
####SBATCH -p ord
####SBATCH --gid=mod3eval
####SBATCH -A mod3eval
####SBATCH -o /work/MOD3EVAL/wtt/CMAQ_v54_Dev/CMAQv54_Base_M3DRY/2018_12US1_%j.txt
...
# cd ../..
 source /shared/build/openmpi_gcc/CMAQ_v54+/config_cmaq.csh
# cd CCTM/scripts
...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = M3DRY_2018_12US1_192_lustre_codefix_lu  #> Application Name (e.g. Gridname)
...
# setenv CMAQ_HOME 	/home/kappel/CMAQ_Code/PROJECTS/CMAQv5321_22Dec2020_EQUATES
# setenv CMAQ_HOME	/home/kappel/CMAQ_Code/PROJECTS/CMAQ_Dev_08142020 
...
#> Set Working, Input, and Output Directories
 ...
 setenv OUTDIR  /lustre/data/output/output_${RUNID} #> Output Directory
 setenv OUTDIR_2017 lustre/data/output_${RUNID_2017}
 setenv INPDIR  /lustre/data/CMAQ_Modeling_Platform_2018/2018_12US1  #Input Directory
...
#> Set Start and End Days for looping
 ...
 set END_DATE = "2018-07-02"
 # set END_DATE   = "2018-12-31"     #> ending date    (December 31, 2017)
...
setenv CTM_STAGE_E20 N       #> Emerson et al. 2020 Aerosol deposition model [default: Y]
...
set BCpath    = $INPDIR/icbc/CMAQv54_2018_108NHEMI_M3DRY      #> boundary conditions input directory
set EMISpath  = $INPDIR/emis/cb6r3_ae6_20190604/cmaq_ready/gridded #> surface emissions input directory
#set EMISpath2 = $INPDIR/emis/cb6r3_ae6_20190604/premerged/rwc	#> surface residential wood combustion emissions directory
set IN_PTpath = $INPDIR/emis/cb6r3_ae6_20190604/  #> elevated emissions input directory (in-line point only)
...
set LUpath    = $INPDIR/misc           #> BELD landuse data for windblown dust model
...
#     if (${YESTERDAY} == 20171231) then
#        set ICpath = $OUTDIR_2017
#        setenv ICFILE CCTM_CGRID_${RUNID_2017}_${YESTERDAY}.nc
#        setenv INIT_MEDC_1 $ICpath/CCTM_MEDIA_CONC_${RUNID_2017}_${YESTERDAY}.nc
#     endif
...
#  set BCFILE = BCON_CONC_12US1_CMAQv533_2018_108NHEMI_STAGE_regrid_${YYYYMM}.nc
 set BCFILE = BCON_CONC_12US1_CMAQv54_2018_108NHEMI_M3DRY_regrid_${YYYYMM}.nc
...
#  setenv SOI_CRO     $METpath/SOI_CRO_$YYYYMMDD.nc
...
#  setenv CMAQ_MASKS $SZpath/12US1_surf.ncf
  ...
  setenv N_EMIS_GR 1
  set EMISfile  = emis_mole_all_${YYYYMMDD}_12US1_nobeis_2018ff_18j_WR401.ncf
  ...
  set STKCASEE = 12US1_cmaq_cb6_2018ff_18j_WR401  # In-line Emission Rate File Suffix
  set STKCASEG = 12US1_2018ff_18j_WR401           # Stack parameter File Suffix
  ...
  setenv STK_EMIS_008 $IN_PTpath/cmv_c3/inln_mole_cmv_c3_20180710_${STKCASEE}.ncf
  ...
  #> In-line lightning NOx options
     ...
     if ( $USE_NLDN == Y ) then
#        setenv NLDN_STRIKES ${IN_LTpath}/NLDN_12km_Daily_mean.${YYYYMMDD}
  ...
  if ( $CTM_BIOGEMIS_MG == 'Y' ) then
    setenv MEGAN_SOILINP    $OUTDIR/CCTM_MSOILOUT_${RUNID}_${YESTERDAY}.nc
         ...
         setenv MEGAN_CTS $INPDIR/surface/CT3_CONUS.ncf
         setenv MEGAN_EFS $INPDIR/surface/EFMAPS_CONUS.ncf
         setenv MEGAN_LDF $INPDIR/surface/LDF_CONUS.ncf
         if ($BDSNP_MEGAN == 'Y') then
            setenv BDSNPINP    $OUTDIR/CCTM_BDSNPOUT_${RUNID}_${YESTERDAY}.nc
            setenv BDSNP_FFILE $INPDIR/surface/FERT_CONUS.ncf
            setenv BDSNP_NFILE $INPDIR/surface/NDEP_CONUS.ncf
            setenv BDSNP_LFILE $INPDIR/surface/LANDTYPE_CONUS.ncf
            setenv BDSNP_AFILE $INPDIR/surface/ARID_CONUS.ncf
            setenv BDSNP_NAFILE $INPDIR/surface/NONARID_CONUS.ncf
         endif
  endif
...
#     setenv BIOSEASON  $IN_BEISpath/bioseason.cmaq.WR413_MYR_2002-2017_12US1.ncf #> ignore season switch file if BIOSW_YN = N 
#     if ($YYYY <= 2017) then
#        setenv BIOSEASON $IN_BEISpath/bioseason.cmaq.WR413_MYR_2002-2017_12US1.ncf
#     else
#        setenv BIOSEASON $IN_BEISpath/bioseason.cmaq.WR413_MYR_${YYYY}_12US1.ncf_full     
#     endif
...
#  setenv OCEAN_1 /work/MOD3DATA/CMAQv53_TS/misc/12US1_surf.ncf
  ...
  if ( $CTM_ABFLUX == 'Y' ) then
     ...
     setenv E2C_SOIL ${INPDIR}/epic/${YYYY}r1_EPIC0509_12US1_soil.nc4
     setenv E2C_CHEM ${INPDIR}/epic/${YYYY}r1_EPIC0509_12US1_time${YYYYMMDD}.nc4
     setenv E2C_LU $INPDIR/misc/beld4_12US1_2011.nc4
  endif
...
# =====================================================================
  ...
  setenv tr_matrix_nml $INPDIR/misc/Species_Table_TR_EQUATES_12US1.nml
...
#   mkdir -p $ASMDIR_COMBINE2
  ...
  #  sbatch --export=ALL /work/MOD3EVAL/wtt/CMAQ_v54_Dev/post/combine_cmaqv54_aconc_dep_conc_cb6r5_ae7_aq_batch.csh
