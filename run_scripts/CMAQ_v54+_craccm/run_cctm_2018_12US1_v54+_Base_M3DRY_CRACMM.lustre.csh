...
#> Set Working, Input, and Output Directories
 ...
 setenv DISK lustre/data_lim_craccm/
 setenv OUTDIR  /$DISK/output/output_${RUNID} #> Output Directory
 setenv OUTDIR_2017 /$DISK/output/output_${RUNID_2017}
 setenv INPDIR  /$DISK/CMAQ_Modeling_Platform_2018/2018_12US1  #Input Directory
...
#> Set Start and End Days for looping
 setenv NEW_START TRUE             #> Set to FALSE for model restart
  ...
  set END_DATE   = "2017-12-23"     #> ending date    (December 31, 2017)
...
# =====================================================================
  ...
  if ($NEW_START == true || $NEW_START == TRUE ) then
     setenv ICFILE CCTM_CGRID_v532_cb6r3_ae7_aq_mapped_to_cracmm1_aq_WR413_MYR_STAGE_2017_12US1_20171221.nc
