...
## data on /mnt directory
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=120
#SBATCH --exclusive
#SBATCH -J CMAQ
#SBATCH -o /shared/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.10x12pe.2day_remove_native_sleep.cyclecloud.mntscratch.log
#SBATCH -e /shared/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.10x12pe.2day_remove_native_sleep.cyclecloud.mntscratch.log
...
## Copy data from /data to /mnt/scratch

cp -r /data/CONUS /mnt/scratch/
...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = 2016_CONUS_10x12pe_mnt_scratch        #> Application Name (e.g. Gridname)
...
#> Set Working, Input, and Output Directories
 ...
 setenv DISK mnt                           # FAST I/O DISK /shared or /fsx
 setenv CMAQ_DATA /data/output
 #mkdir $CMAQ_DATA
 setenv OUTDIR  ${CMAQ_DATA}/output_CCTM_${RUNID} #> Output Directory
 setenv INPDIR  /$DISK/scratch/CONUS/12US2  #Input Directory
