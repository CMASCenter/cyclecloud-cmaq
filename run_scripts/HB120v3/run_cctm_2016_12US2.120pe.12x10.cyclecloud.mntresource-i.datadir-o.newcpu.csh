...
## input data on /mnt resource directory output data on /data directory
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=120
#SBATCH --exclusive
#SBATCH -J CMAQ
#SBATCH -o /shared/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.12x10pe.2day_remove_native_sleep.cyclecloud.mntresource-i.datadir-o.newcpu.log
#SBATCH -e /shared/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.12x10pe.2day_remove_native_sleep.cyclecloud.mntresource-i.datadir-o.newcpu.log
...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = 2016_CONUS_12x10pe_mntresource-i.datadir-o_newcpu       #> Application Name (e.g. Gridname)
