#!/bin/csh -f
## For Cyclecloud HB120v3 (120 cpu)
## input data on /mntresource directory output data on /data directory
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=120
#SBATCH --exclusive
#SBATCH -J CMAQ
#SBATCH -o /shared/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.10x12pe.2day_remove_native_sleep.cyclecloud.mntresource-i.datadir-o.newcpu.log
#SBATCH -e /shared/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.10x12pe.2day_remove_native_sleep.cyclecloud.mntresource-i.datadir-o.newcpu.log
...
sinfo
echo 'node job is running on'
echo $SLURM_JOB_NODELIST
echo 'detailed per node information'
...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = 2016_CONUS_10x12pe_mntresource-i.datadir-o_newcpu       #> Application Name (e.g. Gridname)
...
#> Set Working, Input, and Output Directories
 ...
 setenv DISK data                            # FAST I/O DISK /shared or /fsx
...
# setenv INPDIR  /$DISK/CONUS/12US2  #Input Directory
 setenv INPDIR  /mnt/resource/data2/CONUS/12US2  #Input Directory
