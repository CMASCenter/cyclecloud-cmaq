...
#SBATCH --exclusive
#SBATCH -J CMAQ
#SBATCH -o /mnt/nvme/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.96.12x8pe.2day.cyclecloud.nvme.pin.log
#SBATCH -e /mnt/nvme/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.96.12x8pe.2day.cyclecloud.nvme.pin.log
...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = 2016_CONUS_96_12x8pe_nvme_pin       #> Application Name (e.g. Gridname)
...
#> Set Working, Input, and Output Directories
 ...
 #setenv CMAQ_DATA /21dayscratch/scr/l/i/lizadams/CMAQv5.3.2_CONUS/output
  setenv DISK /mnt/nvme                           # FAST I/O DISK /shared or /fsx or /data
...
# ===================================================================
  ...
  setenv SLURM_NTASKS_PER_NODE 96
...
if ( $SLURM_NTASKS_PER_NODE == "120" ) then
  ...
  #scontrol show hostnames "$SLURM_JOB_NODELIST" | perl -ne 'chomb; print "$_"x1' > hostfile1_96.txt
  ...
  #( /usr/bin/time -p mpirun -machinefile ./hostfile1_96.txt -np $SLURM_NTASKS $PIN_PROCESSOR_LIST --rank-by slot -mca coll ^hcoll $BLD/$EXEC ) |& tee buff_${EXECUTION_ID}.txt
  ...
  (/usr/bin/time -p mpirun -np 96 --bind-to l3cache --map-by ppr:24:numa -x LD_LIBRARY_PATH -x PATH -x PWD $BLD/$EXEC ) |& tee buff_${EXECUTION_ID}.txt
  #sleep 60
