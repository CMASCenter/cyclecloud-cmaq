...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = 2016_CONUS_120_13x9pe_nvme_pin       #> Application Name (e.g. Gridname)
...
# ===================================================================
  ...
  setenv SLURM_NTASKS_PER_NODE 117
...
if ( $SLURM_NTASKS_PER_NODE == "120" ) then
  ...
  (/usr/bin/time -p mpirun -np $NPROCS --report-bindings -x LD_LIBRARY_PATH -x PATH -x PWD $BLD/$EXEC ) |& tee buff_${EXECUTION_ID}.txt
  sleep 60
