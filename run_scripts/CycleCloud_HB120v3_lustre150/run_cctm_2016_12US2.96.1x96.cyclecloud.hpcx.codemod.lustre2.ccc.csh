...
## comment out constrain cores
## So, once you have configured the slurm scheduler node in CycleCloud, you will want to log in to that node and edit the /etc/slurm/cgroup.conf file and comment out the following line: 
## ConstrainCores=yes
## Then, restart slurmctld service:
## sudo systemctl restart slurmctld
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=96
#SBATCH --exclusive
#SBATCH -J CMAQ
#SBATCH -o /shared/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.96.12x8pe.2day.cyclecloud.lustre2.codemod.pin.ccc.log
#SBATCH -e /shared/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.96.12x8pe.2day.cyclecloud.lustre2.codemod.pin.ccc.log
...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = 2016_CONUS_96_12x8pe_lustre2_codemod_pin_ccc        #> Application Name (e.g. Gridname)
