...
#SBATCH --exclusive
#SBATCH -J CMAQ
#SBATCH -o /shared/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.288.16x18pe.2day.cyclecloud.data.epacode.pin.restart.diffmethod.log
#SBATCH -e /shared/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.288.16x18pe.2day.cyclecloud.data.epacode.pin.restart.diffmethod.log
...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = 2016_CONUS_288_16x18pe_data_epacode_pin_restart_diffmethod        #> Application Name (e.g. Gridname)
...
#> is located by default).
 set BLD       = ${CMAQ_HOME}/CCTM/scripts/BLD_CCTM_${VRSN}_${compilerString}_epa_mod
...
#> Set Working, Input, and Output Directories
 ...
 #setenv CMAQ_DATA /21dayscratch/scr/l/i/lizadams/CMAQv5.3.2_CONUS/output
  setenv DISK data                           # FAST I/O DISK /shared or /fsx or /data
 setenv CMAQ_DATA /$DISK/data/output
 setenv OUTDIR  ${CMAQ_DATA}/output_CCTM_${RUNID} #> Output Directory
 setenv INPDIR  /$DISK/CONUS/12US2  #Input Directory
