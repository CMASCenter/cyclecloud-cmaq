...
## data on /lustre directory
#SBATCH --nodes=6
#SBATCH --ntasks-per-node=64
#SBATCH --exclusive
#SBATCH -J CMAQ
#SBATCH -o /shared/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.6x64.384.24x16pe.2day.cyclecloud.lustre.codemod.pin.HBv64rs.log
#SBATCH -e /shared/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.6x64.384.24x16pe.2day.cyclecloud.lustre.codemod.pin.HBv64rs.log
...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = 2016_CONUS_384_6x64_24x16pe_lustre_codemod_pin_HBv64rs        #> Application Name (e.g. Gridname)
...
#> Set Working, Input, and Output Directories
 ...
 #setenv CMAQ_DATA /21dayscratch/scr/l/i/lizadams/CMAQv5.3.2_CONUS/output
  setenv DISK lustre                           # FAST I/O DISK /shared or /fsx or /data
...
# ===================================================================
  ...
  #( /usr/bin/time -p $BLD/$EXEC ) |& tee buff_${EXECUTION_ID}.txt
    ...
    if ( $SLURM_NTASKS_PER_NODE == "64" ) then

        setenv PIN_PROCESSOR_LIST "--bind-to cpulist:ordered --cpu-list 0,4,8,12,16,20,24,28,32,36,40,44,48,52,56,60,1,5,9,13,17,21,25,29,33,37,41,45,49,53,57,61,2,6,10,14,18,22,26,30,34,38,42,46,50,54,58,62,3,7,11,15,19,23,27,31,35,39,43,47,51,55,59,63 --report-bindings"
  ...
  #scontrol show hostnames "$SLURM_JOB_NODELIST" | perl -ne 'chomb; print "$_"x1' > hostfile4.txt
  ...
  #( /usr/bin/time -p mpirun -machinefile ./hostfile4.txt -np $SLURM_NTASKS $PIN_PROCESSOR_LIST --rank-by slot -mca coll ^hcoll $BLD/$EXEC ) |& tee buff_${EXECUTION_ID}.txt
