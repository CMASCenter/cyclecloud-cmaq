...
#SBATCH --exclusive
#SBATCH -J CMAQ
#SBATCH -o /data/build/hpcx_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.288.16x18pe.2day.cyclecloud.hpcx.close3.synch3.shared.log
#SBATCH -e /data/build/hpcx_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.288.16x18pe.2day.cyclecloud.hpcx.close3.synch3.shared.log
...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = 2016_CONUS_288_16x18pe_hpcx_shared_close3synch3        #> Application Name (e.g. Gridname)
...
#> Set Working, Input, and Output Directories
 ...
 #setenv CMAQ_DATA /21dayscratch/scr/l/i/lizadams/CMAQv5.3.2_CONUS/output
  setenv DISK shared                           # FAST I/O DISK /shared or /fsx or /data
