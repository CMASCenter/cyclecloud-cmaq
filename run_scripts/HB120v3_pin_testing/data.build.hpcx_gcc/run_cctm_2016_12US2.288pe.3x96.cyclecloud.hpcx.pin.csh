...
#SBATCH --exclusive
#SBATCH -J CMAQ
#SBATCH -o /shared/build/hpcx_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.16x18pe.2day.cyclecloud.hpcx.pin.sleep.log
#SBATCH -e /shared/build/hpcx_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.16x18pe.2day.cyclecloud.hpcx.pin.sleep.log
...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = 2016_CONUS_16x18pe_hpcx_pin_sleep        #> Application Name (e.g. Gridname)
...
# ===================================================================
  ...
  scontrol show hostnames $SLURM_JOB_NODELIST > hostfile.sleep.txt
  ...
  ( /usr/bin/time -p mpirun -machinefile ./hostfile.sleep.txt -np $SLURM_NTASKS $PIN_PROCESSOR_LIST --rank-by slot -mca coll ^hcoll -x LD_LIBRARY_PATH -x PATH -x PWD $BLD/$EXEC ) |& tee buff_${EXECUTION_ID}.txt
