...
#SBATCH --exclusive
#SBATCH -J CMAQ
#SBATCH -o /shared/build/hpcx_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.384.24x16pe.2day.cyclecloud.hpcx.pin.sleep500.log
#SBATCH -e /shared/build/hpcx_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.384.24x16pe.2day.cyclecloud.hpcx.pin.sleep500.log
...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = 2016_CONUS_24x16pe_hpcx_pin_sleep500        #> Application Name (e.g. Gridname)
...
# ===================================================================
  ...
  scontrol show hostnames "$SLURM_JOB_NODELIST" | perl -ne 'chomb; print "$_"x1' > hostfile5.txt
  ...
  ( /usr/bin/time -p mpirun -machinefile ./hostfile5.txt -np $SLURM_NTASKS $PIN_PROCESSOR_LIST --rank-by slot -mca coll ^hcoll $BLD/$EXEC ) |& tee buff_${EXECUTION_ID}.txt
