...
#SBATCH --exclusive
#SBATCH -J CMAQ
#SBATCH -o /shared/build/hpcx_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.16x18pe.2day.cyclecloud.hpcx.reportbindings.sleep300.log
#SBATCH -e /shared/build/hpcx_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.16x18pe.2day.cyclecloud.hpcx.reportbindings.sleep300.log
...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = 2016_CONUS_16x18pe_hpcx_reportbindings_sleep300    #> Application Name (e.g. Gridname)
...
# ===================================================================
  ...
  if ( $SLURM_NODEID == 0 ) then
  	scontrol show hostnames $SLURM_JOB_NODELIST > hostfile.nodeid.txt
  else
  	sleep 10
  endif
