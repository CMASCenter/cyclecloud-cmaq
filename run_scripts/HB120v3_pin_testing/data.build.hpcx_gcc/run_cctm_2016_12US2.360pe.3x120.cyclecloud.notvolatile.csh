...
#SBATCH --exclusive
#SBATCH -J CMAQ
#SBATCH -o /shared/build/hpcx_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.360.20x18pe.2day.cyclecloud.hpcx.prem.orte.log
#SBATCH -e /shared/build/hpcx_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.360.20x18pe.2day.cyclecloud.hpcx.prem.orte.log
...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = 2016_CONUS_360_20x18pe_hpcx_prem_orte        #> Application Name (e.g. Gridname)
...
# =====================================================================
  ...
  setenv CTM_PMDIAG_1    "$OUTDIR/CCTM_PMDIAG_${CTM_APPL}.nc"     #> On-Hour Particle Diagnostics
  setenv CTM_APMDIAG_1   "$OUTDIR/CCTM_APMDIAG_${CTM_APPL}.nc"    #> Hourly Avg. Particle Diagnostics
  ...
  setenv CTM_DRY_DEP_FST "$OUTDIR/CCTM_DDFST_${CTM_APPL}.nc"      #> Dry Dep
  setenv CTM_DEPV_MOS    "$OUTDIR/CCTM_DEPVMOS_${CTM_APPL}.nc"    #> Dry Dep Velocity
  setenv CTM_DEPV_FST    "$OUTDIR/CCTM_DEPVFST_${CTM_APPL}.nc"    #> Dry Dep Velocity
...
# ===================================================================
  ...
  ( /usr/bin/time -p mpirun --mca orte_base_help_aggregate 0 -np $NPROCS --report-bindings $BLD/$EXEC ) |& tee buff_${EXECUTION_ID}.txt
