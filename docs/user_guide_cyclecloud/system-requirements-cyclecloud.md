...
| 180          |   2x90     |    10 x 18         | 1954.20              | 1773.86              |    3728.06      | .518           |  no                | copied                  |  false                      |  no    | $1.4/hr * 2 nodes * 1.036 hr = $2.9 | $3.6/hr * 2 nodes * 1.036 hr = $7.46 | without -march=native compiler flag |
...
| 270           |  3x90          | 15x18         | 1703.19              | 1494.17              |    3197.36       | .444          |  no                | copied                  |  false          |  no | $1.4/hr * 3 nodes * .888hr = $3.72 | 3.6/hr * 3 nodes * .888 = $9.59  | with -march=native compiler flag |
| 360           |  3x120     |  20x18             | 1520.29              |  1375.54             |    2895.83   | .402              |  no                | copied                  |  false         | no   | $1.4/hr * 3 nodes * .804 = $3.38 | 3.6/hr * 3 nodes * .804 = $8.687 | with -march=native compiler flag | 
| 960           |  8x120     | 30x32             | 1223.52              |  1126.19             |    2349.71    | .326             |  no              | copied                    |  false           | no   | $1.4/hr * 8 nodes * .653 = $7.31 | 3.6/hr * 8 nodes * .653 = $18.8   | with -march=native compiler flag |
