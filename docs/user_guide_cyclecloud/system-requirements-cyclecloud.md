...
| ------------- | -----------    | -----------   | ----------------     | ---------------      | ------------------- | -----       | ------------------ | --------------          | ---------                              |   -------- | --------- | ------ | ---------------      |
| 36           |   1x36     |    6x6             | 5933.48              | 5230.05             |   11163.53      | 1.55            |                    | copied                  |  false                                 |             | $1.4/hr * 1 nodes * ? hr = ?                    | $3.6/hr * 1 nodes * ? hr = ?                        | without -march=native compiler flag |
| 90           |   1x90     |    9x10            |   3153.33            |  2758.12             |   5911.45      | .821            |  no                | copied                  |  false                                 |             | $1.4/hr * 1 nodes * 1.642 hr = $2.29             |  $3.6/hr * 1 nodes * 1.642 hr = $ $5.911           |  without -march=native compiler flag |
| 120          |   1x120    |    10x12           | 2829.84              |  2516.07             |   5345.91      | .742            |  no                | copied                  |  false                                 |            | $1.4/hr * 1 nodes * 1.484 hr = $2.08           | $3.6/hr * 1 nodes * 1.484 hr = $5.34                     | without -march=native compiler flag            |
| 180           |  2x90          | 10x18         | 2097.37              | 1809.84              |    3907.21     | .542            |  no                | copied                  |  false                                 |            | $1.4/hr * 2 nodes * 1.08 hr = $3.03 | $3.6/hr * 2 nodes * 1.08 hr = $7.81 | with -march=native compiler flag |
| 180          |   2x90     |    10 x 18         | 1954.20              | 1773.86              |    3728.06      | .518           |  no                | copied                  |  false                                 |             | $1.4/hr * 2 nodes * 1.036 hr = $2.9 | $3.6/hr * 2 nodes * 1.036 hr = $7.46 | without -march=native compiler flag |
| 240          |   2x120    |   20x12            |  1856.50             | 1667.68                     |    3524.18    | .4895            |  no                | copied                  |  false                            |             |   $1.4/hr * 2 nodes * .97 hr = $2.716           |  $3.6/hr * 2 nodes * .97 hr = $6.984   | without -march=native compiler flag |  
| 270           |  3x90          | 15x18         | 1703.19              | 1494.17              |    3197.36       | .444          |  no                | copied                  |  false                   |  | $1.4/hr * 3 nodes * .888hr = $3.72 | 3.6/hr * 3 nodes * .888 = $9.59  | with -march=native compiler flag |
| 360           |  3x120     |  20x18             | 1520.29              |  1375.54             |    2895.83   | .402              |  no                | copied                  |  false                  |   | $1.4/hr * 3 nodes * .804 = $3.38 | 3.6/hr * 3 nodes * .804 = $8.687 | with -march=native compiler flag | 
| 960           |  8x120     | 30x32             | 1223.52              |  1126.19             |    2349.71    | .326             |  no              | copied                    |  false                  |   | $1.4/hr * 8 nodes * .653 = $7.31 | 3.6/hr * 8 nodes * .653 = $18.8   | with -march=native compiler flag |
