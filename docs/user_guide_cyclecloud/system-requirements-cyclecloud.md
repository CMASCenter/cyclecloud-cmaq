...
| ------------- | -----------    | -----------   | ----------------     | ---------------      | -------------------        | ------------------ | --------------          | ---------                              |   -------- | --------- | ------ | ---------------      |
| 36           |   1x36     |    6x6             | 5933.48              | 5230.05             |   11163.53                  |                    | copied                  |  false                                 |             | $1.4/hr * 1 nodes * ? hr = ?                    | $3.6/hr * 1 nodes * ? hr = ?                        | without -march=native compiler flag |
| 90           |   1x90     |    9x10            |   3153.33            |  2758.12             |   5911.45                  |  no                | copied                  |  false                                 |             | $1.4/hr * 1 nodes * 1.642 hr = $2.29             |  $3.6/hr * 1 nodes * 1.642 hr = $ $5.911           |  without -march=native compiler flag |
| 120          |   1x120    |    10x12           | 2829.84              |  2516.07             |   5345.91                  |  no                | copied                  |  false                                 |            | $1.4/hr * 1 nodes * 1.484 hr = $2.08           | $3.6/hr * 1 nodes * 1.484 hr = $5.34                     | without -march=native compiler flag            |
