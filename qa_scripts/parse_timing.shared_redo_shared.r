...
sens.dir  <- '/shared/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/nopin_scripts/'
base.dir  <- '/shared/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/'
files     <- dir(sens.dir, pattern ='run_cctmv5.3.3_Bench_2016_12US2.480.24x20pe.2day.cyclecloud.shared.codemod.nopin.log' )
b.files <- dir(base.dir,pattern='run_cctmv5.3.3_Bench_2016_12US2.480.24x20pe.2day.cyclecloud.shared.codemod.nopin.redo.log')
#Compilers <- c('intel','gcc','pgi')
Compilers <- c('gcc')
# name of the base case timing. I am using the current master branch from the CMAQ_Dev repository.
# The project directory name is used for the sensitivity case. 
base.name <- 'shared_nopin'
sens.name <- 'shared_nopin_redo' 
