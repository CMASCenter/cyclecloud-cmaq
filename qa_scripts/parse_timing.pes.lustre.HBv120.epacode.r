...
files   <- dir(sens.dir, pattern ='run_cctmv5.3.3_Bench_2016_12US2.96.12x8pe.2day.cyclecloud.lustre.epacode.pin.log')
...
b.files <- c('run_cctmv5.3.3_Bench_2016_12US2.192.16x12pe.2day.cyclecloud.lustre.epacode.pin.log','run_cctmv5.3.3_Bench_2016_12US2.288.16x18pe.2day.cyclecloud.lustre.epacode.pin.log','run_cctmv5.3.3_Bench_2016_12US2.384.24x16pe.2day.cyclecloud.lustre.epacode.pin.log','run_cctmv5.3.3_Bench_2016_12US2.480.24x20pe.2day.cyclecloud.lustre.epacode.pin.log','run_cctmv5.3.3_Bench_2016_12US2.576.24x24pe.2day.cyclecloud.lustre.epacode.pin.log')
#Compilers <- c('intel','gcc','pgi')
Compilers <- c('')
# name of the base case timing. I am using the current master branch from the CMAQ_Dev repository.
# The project directory name is used for the sensitivity case. 
base.name <- c('192_2x96','288_3x96','384_4x96','480_5x96','576_6x96')
...
# plot data
   ...
   png(file = paste('epa_all',sens.name,'_',base.name,'.png',sep=''), width = 1024, height = 768, bg='white')
  # png(file = paste(comp,'_',sens.name,'.png',sep=''), width = 1024, height = 768, bg='white')
   barplot(bar.data, main = 'Process Timing on /lustre using 94 cpus/node on HBv120rs using EPA Code',names.arg = b.names,ylab='seconds', col = my.colors, legend = n.proc, xlim = c(0.,xmax),ylim = c(0.,5600.))
   box()
   dev.off()
