...
files   <- dir(sens.dir, pattern ='run_cctmv5.3.3_Bench_2016_12US2.384.24x16pe.2day.cyclecloud.shared.codemod.pin.log')
#b.files <- dir(base.dir,pattern='run_cctmv5.3.3_Bench_2016_12US2.576.24x24pe.2day.cyclecloud.shared.codemod.nopin.redo.log')
b.files <- c('run_cctmv5.3.3_Bench_2016_12US2.384.24x16pe.2day.cyclecloud.data.codemod.pin.log','run_cctmv5.3.3_Bench_2016_12US2.384.24x16pe.2day.cyclecloud.lustre.codemod.pin.log')
