...
files     <- dir(sens.dir, pattern ='run_cctmv5.3.3_Bench_2016_12US2.6x6pe.2day_remove_native_sleep.cyclecloud.datadir.newcpu.log')
b.files <- dir(base.dir,pattern='run_cctmv5.3.3_Bench_2016_12US2.6x6pe.2day_remove_native_sleep.cyclecloud.mnt.resource.data2.log')
...
#base.name <- '9x10pe'
#sens.name <- '20x18pe'
base.name <- '6x6pe_mnt.resource'
sens.name <- '6x6pe_datadir'
