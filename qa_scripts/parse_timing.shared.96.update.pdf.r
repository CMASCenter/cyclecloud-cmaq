...
sens.dir  <- '../../cyclecloud-cmaq/run_scripts/storage_logs/'
base.dir  <- '../../cyclecloud-cmaq/run_scripts/storage_logs/'
...
# get timing info
   ...
   pdf(file = paste('hb120v3_1nodes_96pe_all_filesystem_',comp,'_all',sens.name,'_',base.name,'.pdf',sep=''), width = 9, height = 7, bg='white') 
