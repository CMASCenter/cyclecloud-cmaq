...
b.files <- c('run_cctm5.4plus_Bench_2018_12US1.96.12x8pe.2day.cyclecloud.lustre.codefix.log','run_cctm5.4plus_Bench_2018_12US1.192.16x12pe.2day.cyclecloud.shared.codefix.log','run_cctm5.4plus_Bench_2018_12US1.192.16x12pe.2day.cyclecloud.lustre.codefix.log')
#Compilers <- c('intel','gcc','pgi')
Compilers <- c('gcc')
# name of the base case timing. I am using the current master branch from the CMAQ_Dev repository.
# The project directory name is used for the sensitivity case.
#base.name <- c('data_pin','lustre_pin','shared_pin')
base.name <- c('cmaq5.4plus_lustre_96_pin','cmaq5.4plus_shared_192_pin','cmaq5.4plus_lustre_192_pin')
sens.name <- c('cmaq5.4plus_shared_96_pin')
...
# get timing info
   ...
   png(file = paste('hb120v3_12US1_CMAQv54+_vs_CMAQv54',comp,'_all',sens.name,'_',base.name,'.png',sep=''), width = 1024, height = 768, bg='white')
