...
sens.dir  <- '../../cyclecloud-cmaq/run_scripts/CycleCloud_HB120v3_lustre150/'
base.dir  <- '../../cyclecloud-cmaq/run_scripts/CycleCloud_HB120v3_lustre150/'
...
# get timing info
   ...
   pdf(file = paste('lustre2_1-6nodes',comp,'_all',sens.name,'_',base.name,'.pdf',sep=''), width = 9, height = 7, bg='white')
