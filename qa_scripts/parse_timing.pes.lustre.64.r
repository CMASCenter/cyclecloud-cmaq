...
files   <- dir(sens.dir, pattern ='run_cctmv5.3.3_Bench_2016_12US2.64.8x8pe.2day.cyclecloud.lustre.codemod.pin.log')
...
b.files <- c('run_cctmv5.3.3_Bench_2016_12US2.128.2x64.16x8pe.2day.cyclecloud.lustre.codemod.pin.log','run_cctmv5.3.3_Bench_2016_12US2.3x64.192.16x12pe.2day.cyclecloud.lustre.codemod.pin.log','run_cctmv5.3.3_Bench_2016_12US2.4x64.256.16x16pe.2day.cyclecloud.lustre.codemod.pin.log','run_cctmv5.3.3_Bench_2016_12US2.5x64.320.20x16pe.2day.cyclecloud.lustre.codemod.pin.log','run_cctmv5.3.3_Bench_2016_12US2.6x64.384.24x16pe.2day.cyclecloud.lustre.codemod.pin.log','run_cctmv5.3.3_Bench_2016_12US2.7x64.448.28x16pe.2day.cyclecloud.lustre.codemod.pin.log')
#Compilers <- c('intel','gcc','pgi')
Compilers <- c('lustre')
# name of the base case timing. I am using the current master branch from the CMAQ_Dev repository.
# The project directory name is used for the sensitivity case. 
base.name <- c('128','192','256','320','384','448')
...
# plot data
  ...
  # png(file = paste(comp,'_',sens.name,'.png',sep=''), width = 1024, height = 768, bg='white')
   barplot(bar.data, main = 'Process Timing on /lustre using 64 cpus/node on HBv3 120',names.arg = b.names,ylab='seconds', col = my.colors, legend = n.proc, xlim = c(0.,xmax),ylim = c(0.,5600.))
   box()
   dev.off()
