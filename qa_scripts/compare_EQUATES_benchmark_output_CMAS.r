...
sim1.label <- "Cyclecloud (v5.3.3 w/ GCC) 18x12"
sim1.dir <- "/shared/data/output/output_CCTM_v533_gcc_2016_CONUS_18x12pe/"
sim1.file <- paste0(sim1.dir,"CCTM_ACONC_v533_gcc_2016_CONUS_18x12pe_20151222.nc")

#Directory, file name, and label for second model simulation (sim2)
sim2.label <- "Cyclecloud (v5.3.3 w/ GCC 12x12)"
sim2.dir <- "/shared/data/output/output_CCTM_v533_gcc_2016_CONUS_12x12pe/"
sim2.file <- paste0(sim2.dir,"CCTM_ACONC_v533_gcc_2016_CONUS_12x12pe_20151222.nc")
...
for(species.name in species.compare.list){
  ...
  #sim1.label.simple <- gsub(" |\\(|\\)|/","",sim1.label)
  #sim2.label.simple <- gsub(" |\\(|\\)|/","",sim2.label)
  #sim1.label.simple <- "Cyclecloud18x12" 
  #sim2.label.simple <- "Cyclecloud12x12"
