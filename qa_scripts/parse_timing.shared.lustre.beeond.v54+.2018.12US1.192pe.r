...
b.files <- c('run_cctm5.4plus_Bench_2018_12US1.96.12x8pe.2day.cyclecloud.lustre.codefix.log','run_cctm5.4plus_Bench_2018_12US1.192.16x12pe.2day.cyclecloud.shared.codefix.log','run_cctm5.4plus_Bench_2018_12US1.192.16x12pe.2day.cyclecloud.lustre.codefix.log','run_cctm5.4plus_Bench_2018_12US1_cb6r5_ae6_20200131_MYR.192.8x12pe.2days.beeond.1x96.log', 'run_cctm5.4plus_Bench_2018_12US1_cb6r5_ae6_20200131_MYR.192.16x12pe.2days.20171222start.2x96.log', 'run_cctm5.4plus_Bench_2018_12US1_cb6r5_ae6_20200131_MYR.288.16x18pe.2days.20171222start.3x96.log' )
#Compilers <- c('intel','gcc','pgi')
Compilers <- c('gcc')
# name of the base case timing. I am using the current master branch from the CMAQ_Dev repository.
# The project directory name is used for the sensitivity case.
#base.name <- c('data_pin','lustre_pin','shared_pin')
base.name <- c('cmaq5.4plus_lustre_96','cmaq5.4plus_shared_192','cmaq5.4plus_lustre_192', 'cmaq5.4plus_beeond_96', 'cmaq5.4plus_beeond_192', 'cmaq5.4plus_beeond_288' )
sens.name <- c('cmaq5.4plus_shared_96')
...
# get timing info
   ...
   png(file = paste('hb120v3_12US1_CMAQv54+beeond4',comp,'.png',sep=''), width = 1024, height = 768, bg='white')
