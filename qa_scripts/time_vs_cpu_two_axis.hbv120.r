...
# plot data
   png(file = paste('HBv120','_','Time','_','Cost','_','CPUs','.png',sep=''), width = 1024, height = 768, bg='white')
   x <- csv_data$CPUs
...
plot(x, y1, pch = 13, col = 2, xlab = "CPUs", ylab = "2 Day Total Time (sec)", main = "CMAQv533 Benchmark 2 Day Run Time (seconds) and OnDemand Cost vs CPUs on Single HBv120 Compute Node")
