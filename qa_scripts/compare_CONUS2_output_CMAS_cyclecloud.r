...
sim1.label <- "(Liz mod 288 remove native)"
sim1.dir <- "/data/data/output/output_CCTM_v533_gcc_2016_CONUS_288_16x18pe_data_codemod_lizrepo_editwrconc/"
sim1.file <- paste0(sim1.dir,"CCTM_ACONC_v533_gcc_2016_CONUS_288_16x18pe_data_codemod_lizrepo_editwrconc_20151222.nc")

#Directory, file name, and label for second model simulation (sim2)
sim2.label <- "(EPA 288 16x18 remove native)"
sim2.dir <- "/data/data/output/output_CCTM_v533_gcc_2016_CONUS_288_16x18pe_data_nomarchnative_redo/"
sim2.file <- paste0(sim2.dir,"CCTM_ACONC_v533_gcc_2016_CONUS_288_16x18pe_data_nomarchnative_redo_20151222.nc")
