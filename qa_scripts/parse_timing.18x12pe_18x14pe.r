...
files     <- dir(sens.dir, pattern ='run_cctmv5.3.3_Bench_2016_12US2.216.6x36.18x12pe.2day.log' )
b.files <- dir(base.dir,pattern='run_cctmv5.3.3_Bench_2016_12US2.252.7x36.18x14pe.2day.log')
