...
#  -----------------------
setenv IOAPI_DIR /mnt/build/ioapi-3.2/Linux2_x86_64gfort
setenv NETCDF_DIR /mnt/build/netcdf/lib
setenv NETCDFF_DIR /mnt/build/netcdf/lib
cd /mnt/build/
...
cd CMAQ_REPO_v533
cp /mnt/cyclecloud-cmaq/bldit_project_v533_mnt.csh /mnt/build/CMAQ_REPO_v533
./bldit_project_v533_mnt.csh
#module load openmpi
cd /mnt/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/
cp /mnt/cyclecloud-cmaq/config_cmaq_mnt.csh ../../config_cmaq.csh
./bldit_cctm.csh gcc |& tee ./bldit_cctm.log
cp /mnt/cyclecloud-cmaq/run_scripts/run* /mnt/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/
cd /mnt/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/
