...
#SBATCH --exclusive
#SBATCH -J CMAQ
#SBATCH -o /shared/build/openmpi_gcc/CMAQ_v54+/CCTM/scripts/run_cctm_Bench_2018_12NE3.WRFCMAQ.64.8x8pe.2day.cyclecloud.lustre.3pull.log
#SBATCH -e /shared/build/openmpi_gcc/CMAQ_v54+/CCTM/scripts/run_cctm_Bench_2018_12NE3.WRFCMAQ.64.8x8pe.2day.cyclecloud.lustre.3pull.log
...
set WRF_DIR     = $WORKDIR/BLD_WRFv4.4_CCTM_v54+_gcc # Location of WRF-CMAQ Install
setenv DISK lustre
setenv CMAQ_DATA /$DISK/data
set INPDIR      = ${CMAQ_DATA}/CMAQv5.4_2018_12NE3_Benchmark_2Day_Input/2018_12NE3               # Input directory for WRF & CMAQ
set OUTPUT_ROOT = ${CMAQ_DATA}/output                                # output root directory
